...
<script type="text/javascript">
  ...
  function setPlaceholder() {
    ...
    var placeHolderRev = placeHolder.reverse();
    var time = 2000;
    var out = setInterval(function () {
      var eachElm = placeHolderRev.pop();
      var message = eachElm.split('').reverse();
      $('#searchbox').prop("placeholder", eachElm);
      if (placeHolderRev.length === 0) {
        clearInterval(out);
        setPlaceholder();
      }
    }, time);
